...
public class PrivateParticipationRequestController {
    ...
    public ParticipationRequestDto postRequest(
            ...
            @RequestParam(required = true, name = "eventId") String eventIdString,
            @RequestBody @Valid ParticipationRequestDto participationRequestDto){
        ...
        return participationRequestService.postRequest(participationRequestDto);
    }
}
