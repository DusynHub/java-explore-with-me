...
(
    ...
    commented_on   TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_comments PRIMARY KEY (id),
    CONSTRAINT fk_comments_to_evm_user FOREIGN KEY (commentator_id) REFERENCES ewm_user (id) ON DELETE CASCADE,
    CONSTRAINT fk_comments_to_event FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE
);